...
<div class="bg-white">
  <section id="safety-hero" class="page-hero h-screen relative border-b-2 border-gray-300">
    ...
    <div class="relative h-full flex items-center justify-center">
      <div class="max-w-3xl mx-auto px-8 text-center">
        ...
        <p class="text-xl leading-relaxed mb-12 max-w-2xl mx-auto">
          Support, clarity, and thoughtful safety practices so the retreat experience can unfold with trust.
        </p>
