...
<div class="bg-white">
  <section id="preparation-hero" class="page-hero h-screen relative border-b-2 border-gray-300">
    ...
    <div class="relative h-full flex items-center justify-center">
      <div class="max-w-3xl mx-auto px-8 text-center">
        ...
        <p class="text-xl leading-relaxed mb-12 max-w-2xl mx-auto">
          Preparing the body and nervous system so the experience can unfold with clarity, safety, and care.
        </p>
  ...
  <section class="py-24 px-8">
    <div class="max-w-4xl mx-auto">
      <div class="mb-12">
        <div class="w-16 h-16 border-2 border-gray-900 mx-auto mb-6 flex items-center justify-center">
        ...
        <div class="col-span-7">
          ...
          <div class="space-y-8 text-lg leading-relaxed">
            <div class="flex justify-start gap-8">
              <div class="flex-1 border-2 border-gray-900 p-6 text-center">
      ...
      <div class="space-y-8 text-lg leading-relaxed">
        ...
        <div class="py-12">
          <div class="flex justify-center gap-4 flex-wrap">
            <div class="border-2 border-gray-300 px-6 py-3">Walking.</div>
            <div class="border-2 border-gray-300 px-6 py-3">Stretching.</div>
            <div class="border-2 border-gray-300 px-6 py-3">Yoga.</div>
            <div class="border-2 border-gray-300 px-6 py-3">Qi Gong.</div>
            <div class="border-2 border-gray-300 px-6 py-3">Dancing in your kitchen.</div>
          </div>
        </div>
      ...
      <div class="grid grid-cols-12 gap-12">
        ...
        <div class="col-span-7 space-y-6">
          <div class="bg-gray-50 border-2 border-gray-300 p-8">
            <p class="text-lg leading-relaxed">
              &bull; What does my body need more of right now?
            </p>
          </div>

          <div class="bg-gray-50 border-2 border-gray-300 p-8">
            <p class="text-lg leading-relaxed">
              &bull; What does it need less of?
            </p>
          </div>

          <div class="bg-gray-50 border-2 border-gray-300 p-8">
            <p class="text-lg leading-relaxed">
              &bull; Where am I pushing when I could be listening?
            </p>
          </div>
        </div>
      </div>
  ...
  <section class="py-32 px-8 bg-gray-50">
    <div class="max-w-3xl mx-auto text-center">
      <div class="w-32 h-32 mx-auto rounded-full border-2 border-gray-300 bg-gray-100 mb-16 flex items-center justify-center">
        <span class="text-gray-400 text-xs">ICON</span>
      </div>
      ...
      <div class="space-y-8 text-lg leading-relaxed">
        ...
        <div class="py-12">
          <div class="border-t-2 border-b-2 border-gray-900 py-12 px-8">
            <p class="text-2xl leading-relaxed">
      ...
      <div class="space-y-8 text-lg leading-relaxed">
        ...
        <div class="grid grid-cols-2 gap-6">
          <div class="border-2 border-gray-300 p-8">
            <p>&bull; Prioritize rest</p>
          </div>
          <div class="border-2 border-gray-300 p-8">
            <p>&bull; Reduce late nights</p>
          </div>
          <div class="border-2 border-gray-300 p-8">
            <p>&bull; Limit screens and intense media</p>
          </div>
          <div class="border-2 border-gray-300 p-8">
            <p>&bull; Avoid violent or emotionally charged content</p>
          </div>
        </div>
      ...
      <div class="grid grid-cols-12 gap-12 items-start">
        ...
        <div class="col-span-7 space-y-8 text-lg leading-relaxed">
          ...
          <div>
            ...
            <ul class="border-2 border-gray-900 p-8 space-y-3">
              <li>Alcohol</li>
    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="space-y-12 text-lg leading-relaxed">
        ...
        <div class="flex justify-end">
          <div class="max-w-md">
            <div class="bg-white border-2 border-gray-300 p-8">
              <p>&bull; Awareness has not been offended</p>
            </div>
          </div>
        </div>
      ...
      <div class="grid grid-cols-12 gap-12 items-center">
        ...
        <div class="col-span-7">
          ...
          <p class="text-lg leading-relaxed mb-10 max-w-lg">
            Understanding how to stay oriented when experiences intensify and how to navigate the inner landscape of ceremony.
          </p>

          <div class="space-y-4">
            <a class="w-full px-8 py-4 border-2 border-gray-900 bg-gray-900 text-white text-left block" href="#">
              Continue to Ceremony &rarr;
            </a>
