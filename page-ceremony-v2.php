    ...
    <div class="relative h-full flex items-center justify-center">
      <div class="max-w-3xl mx-auto px-8 text-center">
        ...
        <p class="text-xl leading-relaxed mb-12 max-w-2xl mx-auto">
          A guide to staying oriented when experiences intensify and learning how to move gently through whatever arises.
        </p>
    ...
    <div class="max-w-5xl mx-auto">
      ...
      <div class="relative flex justify-between items-start gap-4">
        ...
        <div class="relative flex-1 flex flex-col items-center">
          ...
          <span class="text-sm text-gray-600">Preparation</span>
        </div>
        ...
        <div class="relative flex-1 flex flex-col items-center">
          ...
          <span class="text-sm font-semibold">Ceremony</span>
        </div>
      ...
      <div class="grid grid-cols-12 gap-12 items-center">
        ...
        <div class="col-span-7">
          ...
          <p class="text-lg leading-relaxed mb-10 max-w-lg">
            How insights continue unfolding after ceremony and how to gently bring them into everyday life.
          </p>
